################################# Question 3 ###################################
#
# Write a function called check_leap_year that one parameter -- year -- and
# returns True if the year is a leap year and False if it's not.
#
# HINT:
# (from Wikipedia)
...
# WRITE SOME TESTS
# (HINT: you can use this list https://www.calendar.best/leap-years.html)
